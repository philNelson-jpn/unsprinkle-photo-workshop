  ...
  return (
    <Wrapper>
      <picture>
        ...
        `}
        />
      <HeroImage alt="Example of photo available on this site (cat with blue eyes staring deeply into your soul)" src="/images/hero-img.jpeg" />
      </picture>
      <Swoop alt="white swooping wave border between top image and bottom content" src="/swoop.svg" />
    </Wrapper>
  );
};
